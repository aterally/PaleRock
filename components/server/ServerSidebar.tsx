...
const styles: Record<string, React.CSSProperties> = {
  ...
  serverName: { flex: 1, fontFamily: 'var(--font-display)', fontWeight: 700, fontSize: 16, letterSpacing: '0.06em', color: 'var(--text)', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' },
  ...
  actionBtn: { display: 'flex', alignItems: 'center', gap: 8, width: '100%', padding: '9px 12px', borderRadius: 'var(--radius-md)', color: 'var(--text-3)', fontSize: 13, cursor: 'pointer', border: '1px dashed var(--border)', transition: 'all var(--transition)', fontFamily: 'var(--font-display)', letterSpacing: '0.04em', marginBottom: 4 },
  ...
  categoryArrow: { fontSize: 11, color: 'var(--text-3)', width: 14, display: 'inline-block' },
  categoryName: { fontSize: 11, letterSpacing: '0.12em', fontFamily: 'var(--font-display)', fontWeight: 700, color: 'var(--text-3)' },
  channelItem: { display: 'flex', alignItems: 'center', gap: 7, width: '100%', padding: '8px 12px', cursor: 'pointer', border: 'none', borderRadius: 'var(--radius-md)', textAlign: 'left', transition: 'all var(--transition)' },
  channelHash: { color: 'var(--text-3)', fontSize: 16, fontWeight: 400, flexShrink: 0 },
  channelName: { fontSize: 14, fontFamily: 'var(--font-display)', fontWeight: 500, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', letterSpacing: '0.02em' },
  addRow: { padding: '10px 6px 0', display: 'flex', flexDirection: 'column', gap: 4 },
  addBtn: { display: 'flex', alignItems: 'center', gap: 6, width: '100%', padding: '7px 12px', borderRadius: 'var(--radius)', color: 'var(--text-3)', fontSize: 12, cursor: 'pointer', border: 'none', background: 'transparent', transition: 'color var(--transition)', letterSpacing: '0.04em', fontFamily: 'var(--font-display)' },
