...
const styles: Record<string, React.CSSProperties> = {
  ...
  header: { padding: '0 14px', height: 64, borderBottom: '1px solid var(--border)', display: 'flex', alignItems: 'center', gap: 8, flexShrink: 0 },
  ...
  serverName: { flex: 1, fontFamily: 'var(--font-display)', fontWeight: 700, fontSize: 17, letterSpacing: '0.06em', color: '#ffffff', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' },
  ...
  actionBtn: { display: 'flex', alignItems: 'center', gap: 8, width: '100%', padding: '9px 12px', borderRadius: 'var(--radius-md)', color: 'var(--text-2)', fontSize: 14, cursor: 'pointer', border: '1px dashed var(--border-bright)', transition: 'all var(--transition)', fontFamily: 'var(--font-display)', letterSpacing: '0.04em', marginBottom: 4 },
  channelList: { flex: 1, overflowY: 'auto', padding: '10px 6px' },
  section: { marginBottom: 4 },
  categoryHeader: { display: 'flex', alignItems: 'center', gap: 4, width: '100%', padding: '7px 10px', cursor: 'pointer', color: 'var(--text-3)', border: 'none', background: 'transparent', textAlign: 'left' },
  categoryArrow: { fontSize: 11, color: 'var(--text-2)', width: 14, display: 'inline-block' },
  categoryName: { fontSize: 12, letterSpacing: '0.12em', fontFamily: 'var(--font-display)', fontWeight: 700, color: 'var(--text-2)' },
  channelItem: { display: 'flex', alignItems: 'center', gap: 8, width: '100%', padding: '11px 14px', cursor: 'pointer', border: 'none', borderRadius: 'var(--radius-md)', textAlign: 'left', transition: 'all var(--transition)' },
  channelHash: { color: 'var(--text-2)', fontSize: 18, fontWeight: 400, flexShrink: 0 },
  channelName: { fontSize: 16, fontFamily: 'var(--font-display)', fontWeight: 600, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', letterSpacing: '0.02em' },
  addRow: { padding: '10px 6px 0', display: 'flex', flexDirection: 'column', gap: 4 },
  addBtn: { display: 'flex', alignItems: 'center', gap: 6, width: '100%', padding: '8px 12px', borderRadius: 'var(--radius)', color: 'var(--text-2)', fontSize: 13, cursor: 'pointer', border: 'none', background: 'transparent', transition: 'color var(--transition)', letterSpacing: '0.04em', fontFamily: 'var(--font-display)' },
